        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <form action="cadastros/insert_modalidade.php" method="get">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="tipo">Tipo de Modalidade</label>
                                        <input type="text" class="form-control form-control-alternative"
                                            placeholder="Informe a modalidade" name="tipo" id="tipo" required=""
