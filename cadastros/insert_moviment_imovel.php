            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-1">
                        <h3 class="mb-0">Status Tramitar Imóvel</h3>
                    </div>
                    <div class="container" style="margin-top:10px">
                        <?php

                        // Atualiza o status do imóvel
                        $sqlImovel = "UPDATE imovel SET status = '$modalidade 'WHERE codigo = $codigo";
                        $queryImovel = mysqli_query($conn, $sqlImovel);

                        // Insere a tramitação do imóvel
                        $data = date('Y-m-d');
                        $sqlTramitacao = "INSERT INTO movimentacao_imovel (corretor,codigo_imovel,status,valor_negocio,data) VALUES ('$corretor','$codigo','$modalidade','$valor','$data')";
                        $queryTramitacao = mysqli_query($conn, $sqlTramitacao);
                    ...
                    <div class="card-footer py-4">
                        <div style="text-align: center">
                            <a href="../list_imovel.php" class="btn btn-icon btn-success" role="button">
