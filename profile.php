            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-lg-7 col-md-10">
                        <h1 class="display-2 text-white">Olá,
                            <?php echo $userLogged ?>
                        </h1>
                        <p class="text-white mt-0 mb-5">
                            Esta é a sua página de perfil. Você pode ver o progresso feito em seu trabalho e gerenciar
                            suas vendas ou aluguéis atribuídos
                        </p>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3 order-lg-2">
                                <div class="card-profile-image">
                                    <a href="#">
                                        <img src="./assets/img/theme/team-1-800x800.jpg" class="rounded-circle">
                                    </a>
                                </div>
                            </div>
                        </div>
