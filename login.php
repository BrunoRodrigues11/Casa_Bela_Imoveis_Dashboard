    ...
    <nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark">
      <div class="container px-4">
        <a class="navbar-brand" href="index.php">
          <img src="assets/img/brand/logo_white.png" />
        </a>
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">Bem-vindo(a) ao Casa Bela Imóveis!</h1>
              <p class="text-lead text-light">
                Onde a gestão imobiliária ganha vida!
              </p>
            </div>
          </div>
        </div>
              ...
              <form role="form" action="user_login.php" method="post">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Usuário" type="text" id="usuario" name="usuario" />
                  </div>
                </div>
                ...
                <div class="custom-control custom-control-alternative custom-checkbox">
                  <input class="custom-control-input" id="lembrar" name="lembrar" type="checkbox" />
